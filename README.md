...
cd TaskManagerAPI
Configurar o banco (H2 em memória) No arquivo src/main/resources/application.properties (exemplo):
properties
Copy
...
Em fase de teste
Mudando de implementação (por exemplo, de usuário em memória para banco)
Simples de propósito, para facilitar o entendimento
📚 O que eu estou aprendendo com esse projeto
